...
def check_expired_subscriptions():
    ...
    expired_subscription  = Subscription.object.filter(
        status='active',
        end_date__lt=now,
    )
    expired_count = 0
    pinned_posts_remove = 0
    ...
    for subscription in expired_subscription:
        ...
        except PinnedPost.DoesNotExists:
            pass
    ...
    return {
        ...
        'pinned_posts_removed': pinned_posts_remove,
    }
